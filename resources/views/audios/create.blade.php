...
<div class="card">
    ...
    <div class="h1">Create Audios {{$message->id}}</div>
    </div>

    <div class="card-body">
    <h5 class="card-title">Name</h5>

     <form method="POST" action="{{ route('audios.store', $message->id) }}" enctype="multipart/form-data">
        @csrf

     <div class="input-group mb-3">
  <!-- <span class="input-group-text" id="basic-addon1"><i class="material-icons">Song Album</i></span> -->
  <input type="text" class="form-control" name='title' placeholder="Audio Name" aria-label="Audio Name" aria-describedby="basic-addon1">
</div>
